...
#SBATCH -o slurm_log/slurm.autorater_tool_inference.%j.out
#SBATCH -e slurm_log/slurm.autorater_tool_inference.%j.out
...
# sbatch scripts/sft.sh "hello world" argument2
